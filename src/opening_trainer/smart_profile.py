...
SMART_PROFILE_LEVELS: tuple[SmartProfileLevelContract, ...] = (
    SmartProfileLevelContract(1, _band(400, 600), 3, True, 10, 5),
    SmartProfileLevelContract(2, _band(600, 800), 4, True, 10, 5),
    SmartProfileLevelContract(3, _band(800, 1000), 5, True, 10, 5),
    SmartProfileLevelContract(4, _band(1000, 1200), 5, True, 10, 5),
    SmartProfileLevelContract(5, _band(1000, 1200), 6, True, 20, 5),
    SmartProfileLevelContract(6, _band(1200, 1400), 6, True, 10, 5),
    SmartProfileLevelContract(7, _band(1200, 1400), 7, True, 20, 5),
    SmartProfileLevelContract(8, _band(1400, 1600), 7, True, 10, 5),
    SmartProfileLevelContract(9, _band(1400, 1600), 3, False, 10, 5),
    SmartProfileLevelContract(10, _band(1400, 1600), 4, False, 10, 5),
    SmartProfileLevelContract(11, _band(1400, 1600), 5, False, 10, 5),
    SmartProfileLevelContract(12, _band(1400, 1600), 6, False, 10, 5),
    SmartProfileLevelContract(13, _band(1400, 1600), 7, False, 20, 5),
    SmartProfileLevelContract(14, _band(1600, 1800), 7, False, 20, 5),
    SmartProfileLevelContract(15, _band(1800, 2000), 7, False, 10, 5),
    SmartProfileLevelContract(16, _band(1800, 2000), 8, False, 20, 5),
    SmartProfileLevelContract(17, _band(2000, 2200), 8, False, 10, 5),
    SmartProfileLevelContract(18, _band(2000, 2200), 9, False, 20, 5),
    SmartProfileLevelContract(19, _band(2200, 2400), 9, False, 10, 5),
    SmartProfileLevelContract(20, _band(2200, 2400), 10, False, 20, 5),
    SmartProfileLevelContract(21, _band(2400, 2600), 10, False, 10, 5),
    SmartProfileLevelContract(22, _band(2400, 2600), 11, False, 20, 5),
    SmartProfileLevelContract(23, _band(2600, 2800), 11, False, 10, 5),
    SmartProfileLevelContract(24, _band(2600, 2800), 12, False, 20, 5),
    SmartProfileLevelContract(25, _band(2800, 3000), 12, False, 10, 5),
    SmartProfileLevelContract(26, _band(2800, 3000), 13, False, 20, 5),
    SmartProfileLevelContract(27, _band(3000, 3999), 13, False, 10, 5),
    SmartProfileLevelContract(28, _band(3000, 3999), 14, False, 20, 5),
    SmartProfileLevelContract(29, _stockfish(), 14, False, 10, 5),
    SmartProfileLevelContract(30, _stockfish(), 15, False, inf, 5),
)
